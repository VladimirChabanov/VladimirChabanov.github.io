...
Проверьте правильность реализации программы на [изображении](./lab5_files/img/one_punch_man.png) [13.1 МБ].
...
4. Кроме стандартных элементов добавьте в отчёт:
   ...
   2. Ответ на вопрос про зашифрованное сообщение: Как зовут и что он обещал?
